...
abstract class RustLibApi extends BaseApi {
  double crateApiCueFps();

  BigInt crateApiCueRemDate();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  double crateApiCueFps() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCueFpsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCueFpsConstMeta => const TaskConstMeta(
        debugName: "FPS",
        argNames: [],
      );
  ...
  BigInt crateApiCueRemDate() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCueRemDateConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCueRemDateConstMeta => const TaskConstMeta(
        debugName: "REM_DATE",
        argNames: [],
      );
