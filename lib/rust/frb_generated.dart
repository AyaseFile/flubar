...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiCueCueReadFileConstMeta =>
      const TaskConstMeta(debugName: "cue_read_file", argNames: ["file"]);
  ...
  TaskConstMeta get kCrateApiFfmpegInitFfmpegConstMeta =>
      const TaskConstMeta(debugName: "init_ffmpeg", argNames: []);
  ...
  TaskConstMeta get kCrateApiFfmpegReadFileConstMeta =>
      const TaskConstMeta(debugName: "read_file", argNames: ["file"]);
  ...
  (Metadata, Properties) dco_decode_record_metadata_properties(dynamic raw) {
    ...
    return (dco_decode_metadata(arr[0]), dco_decode_properties(arr[1]));
  }
  ...
  void sse_encode_list_record_string_metadata_properties(
    List<(String, Metadata, Properties)> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
  ...
  void sse_encode_record_string_metadata_properties(
    (String, Metadata, Properties) self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
