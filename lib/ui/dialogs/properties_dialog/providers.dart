...
class CommonProperties extends _$CommonProperties {
  ...
  IList<CommonPropertiesModel> build() {
    ...
    final codec = _formatStringProperty(
      properties.map((property) => property.codec),
    );
    ...
    final bitRate = _formatIntProperty(
    ...
    final channels = _formatIntProperty(
      properties.map((property) => property.channels),
    );
    ...
    return IList([
      ...
      CommonPropertiesModel(
        id: kBitsPerRawSampleRowId,
        key: '原始采样位数',
        value: bitsPerRawSample,
      ),
      CommonPropertiesModel(
        id: kBitsPerCodedSampleRowId,
        key: '采样位数',
        value: bitsPerCodedSample,
      ),
