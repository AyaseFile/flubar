...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__id3__id3_write_metadata_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__id3__id3_write_picture_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__ffmpeg__init_ffmpeg_impl(port, ptr, rust_vec_len, data_len),
        ...
        7 => wire__crate__api__ffmpeg__read_file_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
